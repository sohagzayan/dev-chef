...
import { Building2, Calendar, Clock, MapPin, Minus, Plus, Search, Wifi, X } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 py-6 lg:px-8">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    ...
                    <aside className="lg:col-span-3">
                        <div className="sticky top-28 max-h-[calc(100vh-140px)] overflow-y-auto rounded-lg border border-gray-200 bg-white px-6 py-4">
                    ...
                    <main className="lg:col-span-6">
                        ...
                        <div className="space-y-4">
                            {jobs.slice((currentPage - 1) * 20, currentPage * 20).map((job) => (
                        ...
                        <div className="sticky top-6 space-y-6">
                            ...
                            <div className="rounded-lg bg-blue-600 p-6 text-white">
                                ...
                                <p className="mb-4 text-sm text-blue-50">
                                    Learn how to create a standout profile that attracts clients and
                                    wins jobs.
                                </p>
                                <Link
                                    href="/resources"
                                ...
                                <div className="space-y-4">
                                    <div className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                                        ...
                                        <p className="text-xs text-gray-600">
                                            Looking for a licensed CPA with extensive experience in

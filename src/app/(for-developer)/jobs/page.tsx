    ...
    const filteredJobs = jobs.filter((job) => {
        ...
        if (selectedSalary !== 'all') {
            ...
            switch (selectedSalary) {
                case '0-50k':
                    matchesSalary = jobSalary <= 50000;
                    break;
                case '50k-100k':
                    matchesSalary = jobSalary > 50000 && jobSalary <= 100000;
                    break;
                case '100k-150k':
                    matchesSalary = jobSalary > 100000 && jobSalary <= 150000;
                    break;
                case '150k+':
                    matchesSalary = jobSalary > 150000;
                    break;
            }
        }

        return (
            matchesSearch && matchesLocation && matchesType && matchesExperience && matchesSalary
        );
    });
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 lg:p-6">
            ...
            <div className="mb-8">
                <div className="mb-4 flex items-center justify-between">
                    <h2 className="text-xl font-semibold text-gray-900">🔥 Top Jobs</h2>
                    <span className="text-sm text-gray-500">Featured opportunities</span>
                </div>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {jobs
                        .filter((job) => job.companyRating >= 4.5 && job.views > 1000)
                        .slice(0, 3)
                        .map((job) => (
                            <motion.div
                                key={job.id}
                            ...
                            >
                                {/* Top Job Badge */}
                                <div className="absolute -right-2 -top-2 rounded-full bg-gradient-to-r from-orange-400 to-red-500 px-3 py-1 text-xs font-medium text-white shadow-lg">
                                    Top Job
                                </div>
                                ...
                                {/* Action Button */}
                                <button className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 text-sm font-medium text-white transition-all duration-200 hover:from-blue-700 hover:to-purple-700 hover:shadow-lg">
                                    View Details
                                </button>
                            </motion.div>
                        ))}

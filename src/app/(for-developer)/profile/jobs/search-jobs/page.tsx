...
export default function SearchJobsPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 lg:p-6">
            {/* Header */}
            <div className="mb-8">
                <h1 className="mb-2 text-3xl font-bold text-gray-900">Search Jobs</h1>
                <p className="text-gray-600">
                    Find your perfect job with advanced search and filtering options
                </p>
            </div>
                ...
                <div className="rounded-2xl bg-white p-6 shadow-lg">
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            ...
                            className="flex items-center space-x-2 font-medium text-blue-600 hover:text-blue-700"
                        >
                        ...
                        <span>
                            Active filters:{' '}
                            {
                                [
                                    ...
                                    selectedExperience !== 'all' && selectedExperience,

...
export default function InterviewPrepLayout({ children }: { children: React.ReactNode }) {
    ...
    const [expandedMenus, setExpandedMenus] = useState<Set<string>>(new Set(['interview-prep']));
    ...
    const navigationItems: ProfileSection[] = [
        ...
        },
        {
            ...
            isActive: false,
            submenu: [
                { id: 'search-jobs', title: 'Job Search' },
        ...
        },
        {
            ...
            submenu: [
                ...
                { id: 'interview-resources', title: 'Interview Resources' },
    ...
    const isSubmenuItemActive = (parentId: string, subItemId: string) => {
        ...
        } else if (parentId === 'learning') {
            switch (subItemId) {
                case 'courses':
                    return pathname === '/profile/learning/courses';
                case 'tutorials':
                    return pathname === '/profile/learning/tutorials';
                case 'certifications':
                    return pathname === '/profile/learning/certifications';
                case 'skills':
                    return pathname === '/profile/learning/skills';
                case 'learning-paths':
                    return pathname === '/profile/learning/learning-paths';
                case 'study-materials':
                    return pathname === '/profile/learning/study-materials';
                default:
                    return false;
            }
        } else if (parentId === 'interview-prep') {
            switch (subItemId) {
                case 'mock-interviews':
                    return pathname === '/interview-prep/mock-interviews';
                case 'interview-questions':
                    return pathname === '/interview-prep/interview-questions';
                case 'coding-challenges':
                    return pathname === '/interview-prep/coding-challenges';
                case 'system-design':
                    return pathname === '/interview-prep/system-design';
                case 'behavioral':
                    return pathname === '/interview-prep/behavioral';
                case 'interview-resources':
                    return pathname === '/interview-prep/interview-resources';
                default:
                    return false;
            }
        }
    ...
    const handleSubmenuClick = async (parentId: string, subItemId: string) => {
        ...
        switch (parentId) {
            ...
            case 'learning':
                switch (subItemId) {
                    case 'courses':
                        await router.push('/profile/learning/courses');
                        break;
                    case 'tutorials':
                        await router.push('/profile/learning/tutorials');
                        break;
                    case 'certifications':
                        await router.push('/profile/learning/certifications');
                        break;
                    case 'skills':
                        await router.push('/profile/learning/skills');
                        break;
                    case 'learning-paths':
                        await router.push('/profile/learning/learning-paths');
                        break;
                    case 'study-materials':
                        await router.push('/profile/learning/study-materials');
                        break;
                    default:
                        break;
                }
            ...
            case 'interview-prep':
                switch (subItemId) {
                    case 'mock-interviews':
                        await router.push('/interview-prep/mock-interviews');
                        break;
                    case 'interview-questions':
                        await router.push('/interview-prep/interview-questions');
                        break;
                    case 'coding-challenges':
                        await router.push('/interview-prep/coding-challenges');
                        break;
                    case 'system-design':
                        await router.push('/interview-prep/system-design');
                        break;
                    case 'behavioral':
                        await router.push('/interview-prep/behavioral');
                        break;
                    case 'interview-resources':
                        await router.push('/interview-prep/interview-resources');
                        break;
                    default:
                        break;
                }
                break;
            case 'jobs':
                // Add navigation for jobs section
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
            ...
            <div className="sticky top-0 z-30 flex items-center justify-between bg-white/80 p-4 shadow-sm backdrop-blur-xl lg:hidden">
                ...
                <h1 className="text-lg font-semibold text-gray-900">DevChef Interview Prep</h1>

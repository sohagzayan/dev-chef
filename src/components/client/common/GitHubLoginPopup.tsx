...
export function GitHubLoginPopup({
    isOpen,
    onClose,
    onSuccess,
    onError,
    userType,
}: GitHubLoginPopupProps) {
    ...
    const handleGitHubLogin = async () => {
        try {
            ...
            const popup = window.open(
                `/api/auth/github/popup?userType=${userType}`,
                'githubLogin',
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4">
                    <p className="text-sm text-gray-600">
                        Click the button below to sign in with your GitHub account. A popup window

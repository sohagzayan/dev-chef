...
const MinimalCardImage = React.forwardRef<
    HTMLDivElement,
    HTMLMotionProps<'div'> & { src: string; alt: string }
...
const MinimalCardTitle = React.forwardRef<HTMLHeadingElement, HTMLMotionProps<'h3'>>(
    ({ className, ...props }, ref) => (
        <motion.h3
            ref={ref}
            initial={{ opacity: 0 }}
...
const MinimalCardDescription = React.forwardRef<HTMLParagraphElement, HTMLMotionProps<'p'>>(
    ({ className, ...props }, ref) => (
        <motion.p
            ref={ref}
            initial={{ opacity: 0 }}
...
const MinimalCardContent = React.forwardRef<HTMLDivElement, HTMLMotionProps<'div'>>(
    ({ className, ...props }, ref) => (
        <motion.div
            ref={ref}
            initial={{ opacity: 0 }}
...
const MinimalCardFooter = React.forwardRef<HTMLDivElement, HTMLMotionProps<'div'>>(
    ({ className, ...props }, ref) => (
        <motion.div
            ref={ref}
            initial={{ opacity: 0 }}
